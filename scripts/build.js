...
function runLocalProjectBuild(project) {
    if (fs.existsSync(`src/${project}/build.js`))
        execSync(`node src/${project}/build.js`, { stdio: 'inherit' });
}

function setVersion(project) {
...
function copyPackageFile(project) {
...
function removeDependency(project) {
