...
test("BraceSyntaxNode: stores leading trivia when provided", (context: TestContext) => {
    ...
    const node = new BraceSyntaxNode("}", location, leading);
...
test("BraceSyntaxNode: stores trailing trivia when provided", (context: TestContext) => {
    ...
    const node = new BraceSyntaxNode("{", location, null, trailing);
...
test("BraceSyntaxNode: stores both leading and trailing trivia when provided", (context: TestContext) => {
    ...
    const leading = new TriviaSyntaxNode("lead", location);
    const trailing = new TriviaSyntaxNode("trail", location);
    const node = new BraceSyntaxNode("{", location, leading, trailing);
