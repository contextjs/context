...
ScriptAttributeValueSyntaxNode.prototype.parseSemanticTokens = function (context: SemanticTokenContext): void {
    context.state.push(SyntaxNodeType.ScriptAttributeValue);
...
ScriptAttributeValueSyntaxNode.prototype.parseLanguage = function (context: LanguageContext): void {
...
ScriptAttributeValueSyntaxNode.prototype.parseStyles = function (context: StyleContext): void {
