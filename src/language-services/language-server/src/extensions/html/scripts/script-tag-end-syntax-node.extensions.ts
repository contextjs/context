...
ScriptTagEndSyntaxNode.prototype.parseSemanticTokens = function (context: SemanticTokenContext): void {
    context.state.push(SyntaxNodeType.ScriptTagEnd);
...
ScriptTagEndSyntaxNode.prototype.parseLanguage = function (context: LanguageContext): void {
...
ScriptTagEndSyntaxNode.prototype.parseStyles = function (context: StyleContext): void {
