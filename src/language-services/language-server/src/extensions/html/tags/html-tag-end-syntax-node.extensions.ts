...
import { HtmlTagEndSyntaxNode } from "@contextjs/views-parser";
...
declare module "@contextjs/views-parser" {
    export interface HtmlTagEndSyntaxNode {
...
HtmlTagEndSyntaxNode.prototype.parseSemanticTokens = function (context: SemanticTokenContext): void {
    context.state.push(SyntaxNodeType.HtmlTagEnd);
...
HtmlTagEndSyntaxNode.prototype.parseLanguage = function (context: LanguageContext): void {
...
HtmlTagEndSyntaxNode.prototype.parseStyles = function (context: StyleContext): void {
