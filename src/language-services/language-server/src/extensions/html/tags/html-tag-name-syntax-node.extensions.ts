...
import { HtmlTagNameSyntaxNode } from "@contextjs/views-parser";
...
declare module "@contextjs/views-parser" {
    export interface HtmlTagNameSyntaxNode {
...
HtmlTagNameSyntaxNode.prototype.parseSemanticTokens = function (context: SemanticTokenContext): void {
    context.state.push(SyntaxNodeType.HtmlTagName);
...
HtmlTagNameSyntaxNode.prototype.parseLanguage = function (context: LanguageContext): void {
...
HtmlTagNameSyntaxNode.prototype.parseStyles = function (context: StyleContext): void {
