...
CDATAEndSyntaxNode.prototype.parseStyles = function (context: StyleContext): void {
...
CDATAEndSyntaxNode.prototype.parseCode = function (context: CodeContext): void {
...
CDATAEndSyntaxNode.prototype.parseSemantics = function (context: SemanticTokenContext): void {
    this.leadingTrivia?.parseSemantics(context);

    context.createToken(this, SyntaxNodeType.CdataEnd);
