...
CDATAStartSyntaxNode.prototype.parseStyles = function (context: StyleContext): void {
...
CDATAStartSyntaxNode.prototype.parseCode = function (context: CodeContext): void {
...
CDATAStartSyntaxNode.prototype.parseSemantics = function (context: SemanticTokenContext): void {
    this.leadingTrivia?.parseSemantics(context);

    context.createToken(this, SyntaxNodeType.CdataStart);
