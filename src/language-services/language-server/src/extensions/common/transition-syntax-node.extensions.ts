...
TransitionSyntaxNode.prototype.parseStyles = function (context: StyleContext): void {
...
TransitionSyntaxNode.prototype.parseCode = function (context: CodeContext): void {
...
TransitionSyntaxNode.prototype.parseSemantics = function (context: SemanticTokenContext): void {
    this.leadingTrivia?.parseSemantics(context);

    context.createToken(this, SyntaxNodeType.Transition);
