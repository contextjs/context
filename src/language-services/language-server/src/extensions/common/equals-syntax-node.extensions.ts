...
EqualsSyntaxNode.prototype.parseStyles = function (context: StyleContext): void {
...
EqualsSyntaxNode.prototype.parseCode = function (context: CodeContext): void {
...
EqualsSyntaxNode.prototype.parseSemantics = function (context: SemanticTokenContext): void {
    this.leadingTrivia?.parseSemantics(context);

    context.createToken(this, SyntaxNodeType.Equals);
