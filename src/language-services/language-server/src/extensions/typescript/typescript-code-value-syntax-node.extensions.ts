...
TypescriptCodeValueSyntaxNode.prototype.parseCode = function (context: CodeContext): void {
...
TypescriptCodeValueSyntaxNode.prototype.parseSemantics = function (context: SemanticTokenContext): void {
    this.leadingTrivia?.parseSemantics(context);

    context.createToken(this, SyntaxNodeType.TypescriptCodeValue);
