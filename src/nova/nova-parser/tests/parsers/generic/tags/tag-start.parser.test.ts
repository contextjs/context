...
test("TagStartParser: parses tag with trivia after", (context: TestContext) => {
    ...
    context.assert.ok(tagStartSyntaxNode.children[2].trivia instanceof TriviaSyntaxNode);
    context.assert.strictEqual(tagStartSyntaxNode.children[2].trivia!.value, "   ");
});
