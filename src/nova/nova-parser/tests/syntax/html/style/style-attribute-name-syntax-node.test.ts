...
test("StyleAttributeNameSyntaxNode: constructs with children and trivia", (context: TestContext) => {
    const child1 = new TestNode();
    const child2 = new TestNode();
    const trivia = new TriviaSyntaxNode("", null!);
    const node = new StyleAttributeNameSyntaxNode([child1, child2], trivia);
...
test("StyleAttributeNameSyntaxNode: children property is readonly", (context: TestContext) => {
    const node = new StyleAttributeNameSyntaxNode([new TestNode()]);
