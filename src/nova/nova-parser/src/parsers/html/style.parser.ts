...
export class StyleParser {
    ...
    public static parse(context: ParserContext): StyleTagSyntaxNode {
        ...
        children.push(TokenParser.parse(context, StyleContentSyntaxNode, this.shouldContentStop));
        ...
        return new StyleTagSyntaxNode(children, TriviaParser.parse(context));
    }
