...
import { StyleTagNameSyntaxNode } from "@contextjs/views-parser";
...
declare module "@contextjs/views-parser" {
    export interface StyleTagNameSyntaxNode {
...
StyleTagNameSyntaxNode.prototype.parseSemanticTokens = function (context: SemanticTokenContext): void {
    context.state.push(SyntaxNodeType.StyleTagName);
...
StyleTagNameSyntaxNode.prototype.parseLanguage = function (context: LanguageContext): void {
...
StyleTagNameSyntaxNode.prototype.parseStyles = function (context: StyleContext): void {
