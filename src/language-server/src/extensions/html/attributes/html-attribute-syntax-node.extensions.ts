...
import { HtmlAttributeSyntaxNode } from "@contextjs/views-parser";
...
declare module "@contextjs/views-parser" {
    export interface HtmlAttributeSyntaxNode {
...
HtmlAttributeSyntaxNode.prototype.parseSemanticTokens = function (context: SemanticTokenContext): void {
...
HtmlAttributeSyntaxNode.prototype.parseLanguage = function (context: LanguageContext): void {
...
HtmlAttributeSyntaxNode.prototype.parseStyles = function (context: StyleContext): void {
    for (const node of this.children)
