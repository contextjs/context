...
import { QuoteSyntaxNode } from "@contextjs/views-parser";
...
declare module "@contextjs/views-parser" {
    export interface QuoteSyntaxNode {
...
QuoteSyntaxNode.prototype.parseSemanticTokens = function (context: SemanticTokenContext): void {
    this.leadingTrivia?.parseSemanticTokens(context);

    context.createToken(this.location, SyntaxNodeType.Quote);

    this.trailingTrivia?.parseSemanticTokens(context);
};

QuoteSyntaxNode.prototype.parseLanguage = function (context: LanguageContext): void {
...
QuoteSyntaxNode.prototype.parseStyles = function (context: StyleContext): void {
